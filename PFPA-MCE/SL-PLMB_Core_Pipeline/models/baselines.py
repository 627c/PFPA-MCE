"""
baselines.py - 顶刊级医学分割基线模型库（完整维度修复版）
包含: UNet, Attention-UNet, UNet++, TransUNet, nnU-Net, Swin-UNet, MobileUNet
✅ 修复 Swin-UNet 显存爆炸及跳跃连接维度对齐问题
✅ 修复 TransUNet 梯度塌陷及解码器通道数计算 Bug
"""
import torch
...
# ===================== 4. TransUNet (2021) - [完全修复通道拼接维度Bug] =====================
class TransUNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1):
        ...
        # 👑 修复通道对齐：vit_out(512) -> up3(256) + e3(256) -> d3(256)
        self.up3 = nn.ConvTranspose2d(512, 256, 2, stride=2)
...
class SwinUNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1):
        ...
        # 👑 修复维度对齐：b(256) -> up3(256) + e3(256) -> d3(256)
